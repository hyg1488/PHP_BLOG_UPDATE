...
<body style="font-family: 'CookieRun-Regular';">
  <div class="site-wrap min-h-screen flex flex-col pt-10">
    <header class="top-bar fixed top-0 inset-x-0 bg-skyblue text-white h-10">
      <div class="container mx-auto h-full flex">
        <a href="/" class="top-bar__logo px-5 flex items-center ">
          <span><i class="fab fa-microblog font-size25"></i></span>&nbsp;
          <span class="ml-2 font-bold hidden sm:inline font-size20"> YUNGI</span>
        </a>
